          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Toggle between monochrome and colored themes
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Entropy Explorer is a desktop application for exploring the
                Entropy testnet blockchain. Connect to the network to view
                real-time block data, search for specific blocks or addresses,
